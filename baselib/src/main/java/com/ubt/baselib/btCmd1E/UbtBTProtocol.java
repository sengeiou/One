...
import static com.ubt.baselib.utils.SPUtils.bytesToHexString;
...
public class UbtBTProtocol {
    ...
    private static int calPackectLength(byte[] param){
...
//                ConvertUtils.byte2HexString(in[in.length-1]));
    ...
    public String toString() {
        return String.format("Packet:[cmd=%02X, raw=%s]",mCmd,  bytesToHexString(toRawBytes()));
    }
