...
public class SkinCompatResources {
    ...
    private String getStringResourse(Context context, int resId) {
        if (!isDefaultSkin) {
            int targetResId = getTargetResId(context, resId);
            if (targetResId != 0) {
     ...
     * @return
     */
    public String[] getArray(Context context, int resId) {

        if (!isDefaultSkin) {
            int targetResId = getTargetResId(context, resId);
            if (targetResId != 0) {
                return mResources.getStringArray(targetResId);
            }
        }
    ...
    public static String getString(Context context, int resId) {
        return getInstance().getStringResourse(context, resId);
    }

    public static String[] getStringArray(Context context,int resId){
        return getInstance().getArray(context,resId);
    }
