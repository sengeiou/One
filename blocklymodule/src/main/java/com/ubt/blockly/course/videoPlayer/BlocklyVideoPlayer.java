...
public class BlocklyVideoPlayer extends StandardGSYVideoPlayer {
    ...
    public void onAutoCompletion() {
        ViseLog.d(TAG, "onAutoCompletion");
        super.onAutoCompletion();
    }

    @Override
    public void onCompletion() {
        ViseLog.d(TAG, "onCompletion");
        super.onCompletion();
    }

    @Override
    public void onSeekComplete() {
        ViseLog.d(TAG, "onSeekComplete");
        super.onSeekComplete();
    }

    @Override
    public void onVideoResume() {
        ViseLog.d(TAG, "onVideoResume");
        super.onVideoResume();
        ViseLog.d(TAG, "onVideoResume:" + getCurrentState());
    }

    @Override
    public void onVideoPause() {
        ViseLog.d(TAG, "onVideoPause");
        super.onVideoPause();
    }
...
//        super.updateStartImage();
    ...
    protected void clickStartIcon() {
        ...
        ViseLog.d(TAG, "clickStartIcon:" + getCurrentState());
