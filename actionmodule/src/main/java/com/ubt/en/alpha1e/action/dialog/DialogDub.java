...
import com.ubt.en.alpha1e.action.mp3.MP3Recorder;
...
//                daoCountDown.start();
        ...
        tvConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ViseLog.d(TAG, "name length:" + name.length());
...
//                }
    ...
    public void deleteMP3RecordFile(String name) {
        if (name.equals("") || name.equals(null)) {
            ...
            ViseLog.d(TAG, "deleteMP3RecordFile:" + name);
    ...
    protected void onStop() {
        ViseLog.d(TAG, "Dialog Dub onStop");
        super.onStop();
        ...
        if (mRecorder != null) {
            try {
                ...
                ViseLog.e(TAG, "throw Ex=" + e.getMessage());
            }
    ...
    class DaoCountDown extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            ViseLog.d(TAG, "sendEmptyMessage 1:" + finish);
            new Thread() {
                @Override
                public void run() {
                    while (true && !finish) {
