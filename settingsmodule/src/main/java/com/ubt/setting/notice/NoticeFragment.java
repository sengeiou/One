...
import com.ubt.baselib.customView.popup.EasyPopup;
...
public class NoticeFragment extends MVPBaseFragment<NoticeContract.View, NoticePresenter> implements NoticeContract.View, BaseQuickAdapter.OnItemLongClickListener, BaseQuickAdapter.OnItemClickListener {
    ...
    @BindView(R2.id.recyclerview_notice)
    ...
    protected void initUI() {
        mNoticeAdapter = new NoticeAdapter(R.layout.setting_layout_notice_item, mNoticeModels);
        ...
        emptyView = LayoutInflater.from(getActivity()).inflate(R.layout.setting_layout_empty, null);
        emptyView = LayoutInflater.from(getActivity()).inflate(R.layout.setting_layout_empty, null);
    ...
    public int getContentViewId() {
        return R.layout.setting_fragment_user_notice;
    }
...
//            ViseLog.d("onItemLongClick", "执行长按事件");
...
//            ViseLog.d("onItemLongClick", "position==========" + position);
//            if (null != mCirclePop) {
//                mCirclePop.dismiss();
//                ViseLog.d("onItemLongClick", "position====dismiss======" + position);
//            } else {
...
//            });
//        } else {
//            ViseLog.d("onItemLongClick", "没有执行长按事件");
//        }
        return false;
    }
    ...
    public void updateStatu(boolean isSuccess, int noticeId) {
        if (isSuccess) {
            ...
            if (null != mCallBackListener) {
                ...
                ViseLog.d("Notice", "updateStatu==" + isSuccess);
            }
        }
    }
    ...
    private void showStatuLayout(int status) {
        if (status == 1) {
            ...
            ivStatu.setImageResource(R.drawable.setting_ic_setting_push_deafult);
            String emptyMsg = "";
            if (mParam1.equals("1")) {
                emptyMsg = "你目前没有任何成就";
            ...
            ivStatu.setImageResource(R.drawable.setting_ic_loading_failed);
        }
